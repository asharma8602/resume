...
\namesection{Yash}{Srivastav}{%
  ...
  \faMobile\enspace\href{tel:+917054133662}{+91-7054133662}%
  \enspace| \enspace%
...
\location{July 2015-Present | CPI:\@ \textbf{8.8/10.0}}
\sectionsep{}
...
\descript{}
\location{\href{https://github.com/yashsriv}{https://github.com/yashsriv}}
\vspace{\topsep}
\begin{tightemize}
...
%\item Developed a simple Android App which acts as a WebSocket Client
  %for a WebSocket Server for the Real Life Game Mafia
